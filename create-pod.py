...
pod_metadata = client.V1ObjectMeta(name='my-pod', namespace='iman')

pod_body = client.V1Pod(api_version='v1', kind='Pod', metadata=pod_metadata, spec=pod_spec)
	
v1.create_namespaced_pod(namespace='iman', body=pod_body)
	
# pod_logs = v1.read_namespaced_pod_log(name='my-pod', namespace='default')

# v1.delete_namespaced_pod(namespace='iman', name='my-pod')
